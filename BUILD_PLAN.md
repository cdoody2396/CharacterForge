...
**Current stage:** **Stage 5.6 — Character Vocabulary V2** (split 5.6a–5.6e — see the
stage block). **Session 1 (2026-07-16) shipped 5.6a + 5.6b DONE-HERE** (the §15 fifth
...
id rewords (grifter/street_urchin/only_one). **Next: 5.6e — the [HARDWARE] render pass** (weak-honor
P3 fields kept-or-cut; full V2 re-acceptance; the carried 5.5b A/B + 3c drills).

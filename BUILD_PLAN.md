...
real-catalog first-window contract beside the 5.6b fixture. **Next: 5.6d — Subset C+D data
(chat-side, render:false) + the free-text swap** (`appearance_notes`→`signature_note`, add
